...
**Question 6** There are `r `nrow(pets %>% filter(species != "Cat" & species != "Dog"))` that are not dogs. They are both of the species `r levels(as.factor(filter(pets, species != "Cat" & species != "Dog")$species))`.
